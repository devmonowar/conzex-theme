...
/*		array(
			...
			'source'             => get_stylesheet_directory() . '/inc/required-plugins/tgm-example-plugin.zip', // The plugin source.
...
*/
		// This is an example of how to include a plugin from an arbitrary external source in your theme.
		array(
			'name'         => 'Conzex For Elementor', // The plugin name.
			'slug'         => 'conzex-for-elementor', // The plugin slug (typically the folder name).
			'source'       => 'https://monowar.ml/conzex-demo/conzex-for-elementor.zip', // The plugin source.
			'required'     => true, 
		),
